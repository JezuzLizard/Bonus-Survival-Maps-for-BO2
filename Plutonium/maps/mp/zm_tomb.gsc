...
setup_perk_machines_not_controlled_by_zone_capture()
{
	...
	{
		level.zone_capture.perk_machines_always_on = array( "specialty_longersprint", "specialty_additionalprimaryweapon", "specialty_armorvest", "specialty_weapupgrade" );
	}
	else if ( isDefined ( level.customMap ) && level.customMap == "excavation" )
	{
		level.zone_capture.perk_machines_always_on = array( "specialty_fastreload", "specialty_additionalprimaryweapon", "specialty_quickrevive", "specialty_weapupgrade" );
	}
	else
	{
		level.zone_capture.perk_machines_always_on = array( "specialty_longersprint", "specialty_fastreload", "specialty_additionalprimaryweapon", "specialty_armorvest", "specialty_quickrevive", "specialty_weapupgrade" );
	}
}
